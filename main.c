...
int main()
{
    ...
    char *post_params = calloc(1, 8192);
    strcpy(post_params, i_params);

    char * req_url = oauth_sign_url2(i_url, &post_params, i_method, i_consumer_key, i_consumer_secret, NULL, NULL);
    printf("\n\n%s\n", req_url);
    printf("%s\n", post_params);
